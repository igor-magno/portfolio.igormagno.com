...
public class Projects
{
    ...
    public static readonly Project[] List =
    {
        ...
        new()
        {
            Name = "BRANDT Brasil",
            Description =
                "Aplicativo corporativo voltado ao setor agrícola, oferecendo conteúdos técnicos e ferramentas para apoiar decisões no manejo e produtividade no campo.",
            Link = "https://agro.brandtbrasil.com/app-brandt-brasil",
            LogoLink =
                "https://play-lh.googleusercontent.com/ZjTrqNiTWffaAWaBTvHjCUPOMQYsOGv4YYOO8Oh44LVfCqFfmkGzibBKqo1u6XcuRu4=w240-h480-rw",
            IsCase = false,
            IsOwner = false,
            IsOpenCode = false,
        ...
        new()
        {
            Name = "EXAMIN",
            Description =
                "Aplicativo para organização e compartilhamento de exames médicos, centralizando histórico de saúde e facilitando o acompanhamento periódico.",
            Link = "https://examin.com.br/",
            LogoLink =
                "https://play-lh.googleusercontent.com/q-ZJhV6dLA0LFuhWgWXLjRd2hOmrgcLKzTDQ_ywz3GqKi1POjOvAjm77D74wFbcPWo4=w240-h480-rw",
            IsCase = false,
            IsOwner = false,
            IsOpenCode = false,
            Client = "EXAMIN"
